    ...
    <div className="w-full">
      ...
      <div className="px-4 py-6">
        <div className="flex flex-col md:flex-row gap-6 items-start">
          <Avatar className="w-20 h-20 md:w-32 md:h-32 rounded-full border-white shadow-md">
            <AvatarFallback className="flex items-center justify-center w-full h-full text-2xl font-semibold">
              {channel.name[0]}
            </AvatarFallback>
          </Avatar>
